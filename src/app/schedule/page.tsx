...
const yearOptions = [ { value: '2024', label: '2024-2025' }]; 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {scheduleData.map((day) => (
            <div key={day.dayName} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="p-1 sm:p-2 divide-y divide-gray-100 max-h-[70vh] overflow-y-auto"> 
                {day.timeSlots.map((slot) => (
                  <div key={slot.time} className="flex items-stretch"> 
