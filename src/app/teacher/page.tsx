...
export default function TeacherPage() {
  ...
  // и фильтроваться по текущему преподавателю
  const mockGroups = [
        ...
        <main className="ml-[70px] lg:ml-[76px] w-full flex flex-col">
          ...
          <div className="flex-1 p-8">
            <div className="max-w-7xl mx-auto">
              <div className="mb-8">
                <h1 className="text-4xl font-bold text-white">Панель преподавателя</h1>
                <p className="mt-2 text-white">
                  Управляйте своими курсами, тестами и материалами
                </p>
              </div>
              ...
              <section className="flex flex-col gap-6">
                ...
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 via-indigo-600 to-sky-600 text-white shadow-xl">
                  ...
                  <div className="relative z-10 p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <Link
                      href="#"
                      className="inline-flex z-0 items-center gap-2 bg-white/10 border border-white/30 px-4 py-2 rounded-xl text-sm text-white/90 hover:bg-white/20 transition shadow"
                    >
                ...
                <Card className="p-6">
                  ...
                  <TestManagementClient
                    educatorId={1} // В реальном приложении будет ID из сессии
